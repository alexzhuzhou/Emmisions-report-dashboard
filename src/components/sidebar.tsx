...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[72px] border-r border-gray-200 bg-card flex flex-col items-center py-4 h-screen sticky top-0">
      <div className="mb-8">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center w-[60px] h-[60px] rounded-md relative transition-all duration-200 group",
                isActive
                  ? "text-primary"
